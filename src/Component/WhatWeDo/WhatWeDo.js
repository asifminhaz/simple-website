...
const WhatWeDo = () => {
  ...
  <div class="card-body">
    ...
    <button className='btn btn-active  m-2 bg-black text-white mx-auto text-center justify-items-center justify-center align-middle'>Our Work</button>
                              ...
                              {/* <div class="hero min-h-screen bg-base-200 text-black">
  <div class="hero-content text-center">
    <div class="max-w-md">
      <p class="py-6 text-3xl font-bold">We use the power of design and technology to solve complex problems and transform business</p>
      <button className='btn btn-active  m-12 bg-black text-white mx-auto text-center justify-items-center justify-center align-middle'>Our Work</button>
                              ...
                              {/* <div className='justify-center bg-white m-5'>
                              <h3 className='text-center font-bold text-4xl '>We use the power of design and technology to solve </h3>
                              <h3 className='text-center font-bold text-4xl'>complex problems and transform business</h3>
...
<div class="card w-96 bg-base-100 shadow-xl">
  ...
  <div id="slide1" class="carousel-item relative w-full">
    <img src="https://images.unsplash.com/photo-1553877522-43269d4ea984?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" class="w-full" />
  ...
  <div id="slide2" class="carousel-item relative w-full">
    <img src="https://images.unsplash.com/photo-1531973576160-7125cd663d86?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" class="w-full" />
    <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  ...
  <div id="slide3" class="carousel-item relative w-full">
    <img src="https://images.unsplash.com/photo-1499754162586-08f451261482?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" class="w-full" />
    <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide2" class="btn btn-circle">❮</a> 
      <a href="#slide4" class="btn btn-circle">❯</a>
    </div>
  ...
  <div id="slide4" class="carousel-item relative w-full">
    <img src="https://images.unsplash.com/photo-1536924940846-227afb31e2a5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=866&q=80" class="w-full" />
    <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide3" class="btn btn-circle">❮</a> 
      <a href="#slide1" class="btn btn-circle">❯</a>
    </div>
...
<div class="card card-side bg-base-100 ">
  ...
  <div class="card-body">
    ...
    <h2 class="card-title">User Centric</h2>
    <p>We create experiences that improve our collective human experience.</p>
  
    <h2 class="card-title">Systematically Tested</h2>
    <p>We validate our solutions by creating testable experiments that produce exceptional outcomes.</p>
  
  
    <h2 class="card-title">Financially Impactful</h2>
    <p>We deliver work that has immediate, substantial, and sustained impact on your bottom line. </p>
...
<div className="card card-compact    bg-base-100 shadow-xl ">
  ...
  <div class="card-body">
    ...
    <p>In this episode, Jessica Hartley VP of Strategy and your host, is joined by Miasha Nakahara, Associate Creative Director, Jamal Qutub, Associate Director of Visual Craft, and Ramona Todoca, Associate Creative Director, to discuss what it means to be a diverse workforce of thoughtful makers and creators, who are building the bridges between brands and consumers.</p>
...
<div className="card card-compact   bg-base-100 shadow-xl ">
  ...
  <div class="card-body">
    ...
    <p>Our VP of strategy, Jessica Hartley, is joined by creative director, Nishat Akhtar, strategy director, Ravi Mongia, and executive producer, Leon Anderson, to discuss how industries can deliver transformational change for Black professionals and the steps Instrument is taking to become more anti-racist.</p>
