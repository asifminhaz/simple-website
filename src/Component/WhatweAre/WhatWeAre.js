...
const WhatWeAre = () => {
          return (
                    <div className='bg-white'>
                              <div class="card   shadow-xl justify-center mx-auto pt-20">
  <div class="card-body">
...
<div class=" carousel carousel-horizontal rounded-box">
  <div class="carousel-item h-full">
    <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" />
  </div> 
  <div class="carousel-item h-full">
    <img src="https://images.unsplash.com/photo-1538688423619-a81d3f23454b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" />
  </div> 
  <div class="carousel-item h-full">
    <img src="https://images.unsplash.com/photo-1516383740770-fbcc5ccbece0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" />
  </div> 
  <div class="carousel-item h-full">
    <img src="https://images.unsplash.com/photo-1516062423079-7ca13cdc7f5a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=883&q=80" />
  </div> 
  <div class="carousel-item h-full">
    <img src="https://images.unsplash.com/photo-1531539134685-27d854339120?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" />
  </div> 
  <div class="carousel-item h-full">
...
<div class="card   shadow-xl justify-center mx-auto mt-12 justify-items-center  align-middle ">
  <div class="card-body">
    {/* <h2 class="card-title text-center text-4xl">We believe in making the best work,and being the best to work with</h2> */}
...
<div class="card  glass">
  <figure><img src="https://images.prismic.io/instrument-v5/cb15ecd5-f3cf-4e8c-a88c-52b0ef74671e__instrument-2020_j7drfc.jpg?auto=compress,format&w=1920" alt="car!"></img></figure>
  <div class="card-body">
...
<div class="card card-compact bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <h2 class="text-center  ">Explore open role</h2>
